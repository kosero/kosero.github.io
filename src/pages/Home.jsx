...
const Home = ({ triggerCrash }) => {
  return (
    <div
      className="w-full max-w-7xl mx-auto py-12 flex flex-col gap-24"
      style={{ paddingLeft: "4rem", paddingRight: "4rem" }}
    >
      <section
        id="home"
        className="min-h-[50vh] flex flex-col md:flex-row items-center justify-center gap-16"
      >
        <motion.div
        ...
        <div className="space-y-6 max-w-xl text-center md:text-left">
          ...
          >
            I'm a self-taught game developer. I mainly work on games, and in my
            spare time I tinker with low-level graphics programming. I love C.
          </motion.p>
        </div>
      </section>
      ...
      <section id="skills" className="w-full flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full items-stretch">
          <div className="w-full space-y-8">
            <SkillBar name="C Language" level="ADVANCED" />
            <SkillBar name="Linux Ops" level="ADVANCED" />
            <SkillBar name="Python" level="INTERMEDIATE" />
            <SkillBar name="Rust" level="INTERMEDIATE" />
            <SkillBar name="C#" level="NOVICE" />
            <SkillBar name="Godot" level="INTERMEDIATE" />
            <SkillBar name="OS Dev" level="BEGINNER" />
          </div>

          <div
            className="bg-[rgba(var(--text-dim),0.05)] border border-[var(--text-dim)] relative flex flex-col justify-center min-h-[300px]"
          ...
          >
            ...
            <ul className="space-y-4 text-sm font-mono opacity-80 list-disc pl-6">
              ...
              <li>
                Building tools from scratch to understand how things work.
              </li>
            </ul>
      ...
      <section id="contact" className="pb-24 text-center">
        ...
        <div className="flex justify-center gap-12 text-lg">
          ...
          <span>//</span>
          <a
            href="http://discord.com/users/1418736782492700672"
            className="hover:text-[var(--text-dim)] transition-colors"
          >
            DISCORD
          </a>
