...
import DiscordSvg from "~/pages/aboutme/discord.svg";
import MAL from "~/pages/aboutme/myanimelist.svg";

function SteinsGate() {
  return (
    <a className="text-blue-400" href="https://myanimelist.net/anime/9253">Steins;Gate</a>
  )
}

function NierAutomata() {
  return (
    <a className="text-blue-400" href="https://store.steampowered.com/app/524220">Nier: Automata</a>
  )
}

function NhkNiYoukoso() {
  return (
    <a className="text-blue-400" href="https://myanimelist.net/anime/1210">NHK ni Youkoso</a>
  )
}

function Discord() {
  return (
    <a className="text-blue-400" href="https://discord.gg/J24pSszkc9">Discord</a>
  )
}
...
export default function AboutMe() {
  const socials = [
    ...
    { icon: <img src={DiscordSvg} />, url: "http://discord.com/users/1418736782492700672", label: "Discord" },
      ...
      <div className="aboutmeBox absolute bottom-3">
        ...
        <div className="flex items-center justify-center text-center space-x-4 mt-2">
            {socials.map((social, index) => (
              ...
              >
                {social.icon}
                <span className="absolute left-0 bottom-8 mt-2 opacity-0 group-hover:opacity-100 transition-opacity bg-black rounded-md border-1 border-white px-2 py-1">
                  {social.label}
                </span>
              </a>
            ))}
